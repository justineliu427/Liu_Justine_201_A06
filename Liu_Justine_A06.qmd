...
max_med_year <- which.max(median_annual)
min_med_year <- which.min(median_annual)

print(paste0("The maximum median annual temperature of ", median_annual[max_med_year], " occurred in ", max_med_year, " and the minimum median annual temperature of ", median_annual[min_med_year], " occurred in ", min_med_year, "."))
```
