...
points_per_game <- sapply(player_info, function(player_info){player_info$points/player_info$games_played})
print(points_per_game)

# name each element with respective player's initials
for(val in player_info$name){
  player_info$name$points_game <- points_per_game
}
print(player_info)
```
...
```{r}
mat_rounded <- lapply(mat_rand, function(x){
